...
namespace JichangeApi.Services.setup
{
    public class EmailTextService
    {
        ...
        private void AppendInsertAuditTrail(long sno, EMAIL email, long userid)
        {
            ...
            Auditlog.InsertAuditTrail(values, userid, EmailTextService.tableName, EmailTextService.tableColumns);
        }
        ...
        private void AppendUpdateAuditTrail(long sno,EMAIL oldEmail,EMAIL newEmail,long userid)
        {
            ...
            Auditlog.UpdateAuditTrail(oldValues, newValues, userid, EmailTextService.tableName, EmailTextService.tableColumns);
        }
        ...
        private void AppendDeleteAuditTrail(long sno, EMAIL fetchedEmail, long userid)
        {
            ...
            Auditlog.deleteAuditTrail(values, userid, EmailTextService.tableName, EmailTextService.tableColumns);
        }
        ...
        public EMAIL FindEmail(long sno)
        {
            try
            {
                EMAIL found = new EMAIL().EditEMAIL(sno);
        ...
        public EMAIL InsertEmail(AddEmailForm addEmailForm)
        {
            try
            {
                ...
                bool isDuplicateFlow = email.ValidateEMAIL(addEmailForm.flow.ToString());
        ...
        public List<EMAIL> GetEmailList()
        {
            try
            {
                List<EMAIL> results = new EMAIL().GetEMAIL();
